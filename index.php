                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <a class="button home-btn-bg smoth-scroll" href="#investment"><?php echo $language['learn_more'] ?></a>
                                            <a class="button smoth-scroll" href="http://investment.ecimagroup.com/"><?php echo $language['menu_visit_site'] ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <a class="button home-btn-bg smoth-scroll" href="#energy"><?php echo $language['learn_more'] ?></a>
                                            <a class="button smoth-scroll" href="http://www.cistel-solutions.com/"><?php echo $language['menu_visit_site'] ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <a class="button home-btn-bg smoth-scroll" href="#informatique"><?php echo $language['learn_more'] ?></a>
                                            <a class="button smoth-scroll" href="http://www.ecimaconsulting.com/"><?php echo $language['menu_visit_site'] ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <a class="button home-btn-bg smoth-scroll" href="#training"><?php echo $language['learn_more'] ?></a>
                                            <a class="button smoth-scroll" href="http://recrutement.ecimaconsulting.com/"><?php echo $language['menu_visit_site'] ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<section id="investment" class="partner-area section-padding">
    <div class="container">
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="video-area">
                    <img src="assets/img/ecima/img12.jpeg" width="100%">
                </div>
            </div>
...
<section id="energy" class="choose-area section-padding">
    <div class="container">
        <div class="row">
            <!-- START SECTION TITLE DESIGN AREA -->
            <div class="col-md-12">
...
<section id="informatique" class="partner-area section-padding">
    <div class="container">
        <div class="row">
            <!-- START SECTION TITLE DESIGN AREA -->
            <div class="col-md-12">
...
<section id="training" class="how-work-area section-padding">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <br>
                <div class="video-area">
                    <img width="100%" src="assets/img/ecima/img13.jpg">
                </div>
            </div>
        </div>
        <div class="portfolio-btn text-center">
